...
public class Testing2 
{
	...
	public static void main(String[] args) 
	{
		...
		while(continuetyVariable == 1)
		{
			...
			System.out.println("1 ----> to create Instructor object");
			System.out.println("1 ----> to create Administrator object");
			System.out.println("1 ----> to create Technical object");
