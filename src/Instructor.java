...
public class Instructor extends Staff
{
	...
	{
		return String.format("%s%n%s%n%s: %s%n%s: %d%n%s: %s", super.toString(), "This instructor object has:", "Department", getDepartment(), "Hours", getHours(), "Subjects", subjects.toString());
	}
